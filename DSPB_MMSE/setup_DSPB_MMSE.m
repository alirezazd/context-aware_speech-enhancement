...
DSPB_MMSE_param.TF = 32; %log2(total input frames)
DSPB_MMSE_param.index = 0;
DSPB_MMSE_param.sync_irq = 1;
...
%wav_file = awgn(wav_file,0,'measured');  %add white noise, 5db SNR
...
%write frames
    ...
    DSPB_MMSE_IO.bus_data_in(1,DSPB_MMSE_param.endTime) = DSPB_MMSE_param.sampledata(50,DSPB_MMSE_param.index);
    DSPB_MMSE_IO.bus_wen(1,DSPB_MMSE_param.endTime)=1;
    DSPB_MMSE_param.endTime = DSPB_MMSE_param.endTime + 1;
    DSPB_MMSE_IO.bus_addr_in(1,DSPB_MMSE_param.endTime) = 0;
    DSPB_MMSE_IO.bus_data_in(1,DSPB_MMSE_param.endTime) = DSPB_MMSE_param.sync_irq;
    DSPB_MMSE_param.sync_irq = ~DSPB_MMSE_param.sync_irq;
    DSPB_MMSE_IO.bus_wen(1,DSPB_MMSE_param.endTime)=1;
    end
    %% Wait for data to get ready (600 for bitrevrsecore & 512 for fft)
    DSPB_MMSE_param.endTime = DSPB_MMSE_param.endTime + 1000;
    DSPB_MMSE_param.index = 0;
    while(DSPB_MMSE_param.index < 2^(DSPB_MMSE_param.FS))
    DSPB_MMSE_param.endTime = DSPB_MMSE_param.endTime + 1;
    DSPB_MMSE_IO.bus_addr_in(1,DSPB_MMSE_param.endTime) = 1;
    DSPB_MMSE_param.index = DSPB_MMSE_param.index + 1;
    DSPB_MMSE_IO.bus_data_in(1,DSPB_MMSE_param.endTime) = DSPB_MMSE_param.sampledata(51,DSPB_MMSE_param.index);
    DSPB_MMSE_IO.bus_wen(1,DSPB_MMSE_param.endTime)=1;
    DSPB_MMSE_param.endTime = DSPB_MMSE_param.endTime + 1;
    DSPB_MMSE_IO.bus_addr_in(1,DSPB_MMSE_param.endTime) = 0;
    DSPB_MMSE_IO.bus_data_in(1,DSPB_MMSE_param.endTime) = DSPB_MMSE_param.sync_irq;
    ...
    DSPB_MMSE_IO.bus_addr_in(1,DSPB_MMSE_param.endTime) = 1;
    DSPB_MMSE_param.index = DSPB_MMSE_param.index + 1;
    DSPB_MMSE_IO.bus_data_in(1,DSPB_MMSE_param.endTime) = DSPB_MMSE_param.sampledata(52,DSPB_MMSE_param.index);
    DSPB_MMSE_IO.bus_wen(1,DSPB_MMSE_param.endTime)=1;
    DSPB_MMSE_param.endTime = DSPB_MMSE_param.endTime + 1;
    DSPB_MMSE_IO.bus_addr_in(1,DSPB_MMSE_param.endTime) = 0;
    DSPB_MMSE_IO.bus_data_in(1,DSPB_MMSE_param.endTime) = DSPB_MMSE_param.sync_irq;
    ...
    DSPB_MMSE_param.endTime = DSPB_MMSE_param.endTime + 1000;
    DSPB_MMSE_IO.bus_wen(1,DSPB_MMSE_param.endTime)=0;
