...
## Generated on : Wed Oct 14 13:35:39 2020
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: ./Embedded_MBSS.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = T:/SBU/Thesis/Codes/Matlab/MBSS/codegen/lib/Embedded_MBSS
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IT:/SBU/Thesis/Codes/Matlab/MBSS -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
SRCS = $(START_DIR)/rt_nonfinite.c $(START_DIR)/rtGetNaN.c $(START_DIR)/rtGetInf.c $(START_DIR)/Embedded_MBSS_data.c $(START_DIR)/Embedded_MBSS_initialize.c $(START_DIR)/Embedded_MBSS_terminate.c $(START_DIR)/Embedded_MBSS.c $(START_DIR)/log2.c $(START_DIR)/fft.c $(START_DIR)/fft1.c $(START_DIR)/ifft.c $(START_DIR)/Embedded_MBSS_emxutil.c $(START_DIR)/Embedded_MBSS_emxAPI.c
...
OBJS = rt_nonfinite.c.o rtGetNaN.c.o rtGetInf.c.o Embedded_MBSS_data.c.o Embedded_MBSS_initialize.c.o Embedded_MBSS_terminate.c.o Embedded_MBSS.c.o log2.c.o fft.c.o fft1.c.o ifft.c.o Embedded_MBSS_emxutil.c.o Embedded_MBSS_emxAPI.c.o
...
fft1.c.o : $(START_DIR)/fft1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ifft.c.o : $(START_DIR)/ifft.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
Embedded_MBSS_emxAPI.c.o : $(START_DIR)/Embedded_MBSS_emxAPI.c
	$(CC) $(CFLAGS) -o "$@" "$<"
