...
if {! [file exists $base_dir/DSPB_MMSE_dut_feature_extraction_SNR_Estimator_1pass_STD_STD_signal]} {
    file delete -force $base_dir/DSPB_MMSE_dut_feature_extraction_SNR_Estimator_1pass_STD_STD_signal
}

project new $base_dir DSPB_MMSE_dut_feature_extraction_SNR_Estimator_1pass_STD_STD_signal
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/DSPB_MMSE/DSPB_MMSE_dut_feature_extraction_SNR_Estimator_1pass_STD_STD_signal_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/DSPB_MMSE/DSPB_MMSE_dut_feature_extraction_SNR_Estimator_1pass_STD_STD_signal_atb.vhd
vcom -quiet $base_dir/DSPB_MMSE/DSPB_MMSE_dut_feature_extraction_SNR_Estimator_1pass_STD_STD_signal_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_2_std} mismatch] == 0 && $mismatch } {
                report_mismatch out_2_std $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps DSPB_MMSE_dut_feature_extraction_SNR_Estimator_1pass_STD_STD_signal_atb 
    do $base_dir/DSPB_MMSE/DSPB_MMSE_dut_feature_extraction_SNR_Estimator_1pass_STD_STD_signal_atb.wav.do
