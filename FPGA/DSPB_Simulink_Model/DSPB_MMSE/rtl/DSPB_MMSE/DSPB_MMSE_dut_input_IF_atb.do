...
if {! [file exists $base_dir/standaloneTopLevel_DSPB_MMSE_dut_input_IF]} {
    file delete -force $base_dir/standaloneTopLevel_DSPB_MMSE_dut_input_IF
}

project new $base_dir standaloneTopLevel_DSPB_MMSE_dut_input_IF
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/DSPB_MMSE/DSPB_MMSE_dut_input_IF_fpc.do"
} else {
...
vcom -quiet $base_dir/DSPB_MMSE/standaloneTopLevel_DSPB_MMSE_dut_input_IF.vhd
...
vcom -quiet -O0 $base_dir/DSPB_MMSE/DSPB_MMSE_dut_input_IF_atb.vhd
vcom -quiet $base_dir/DSPB_MMSE/DSPB_MMSE_dut_input_IF_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_Noisy_Signal_Valid} mismatch] == 0 && $mismatch } {
                report_mismatch Noisy_Signal_Valid $cyclenum
            }
            if { [catch {exa mismatch_Noisy_Signal} mismatch] == 0 && $mismatch } {
                report_mismatch Noisy_Signal $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps standaloneTopLevel_DSPB_MMSE_dut_input_IF_atb 
    do $base_dir/DSPB_MMSE/DSPB_MMSE_dut_input_IF_atb.wav.do
