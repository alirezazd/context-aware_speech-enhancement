...
entity DSPB_MMSE_dut_input_adapter_Hamming_window_atb is
end;

architecture normal of DSPB_MMSE_dut_input_adapter_Hamming_window_atb is
...
component DSPB_MMSE_dut_input_adapter_Hamming_window_stm is
    port (
...
dut : DSPB_MMSE_dut_input_adapter_Hamming_window port map (
...
sim : DSPB_MMSE_dut_input_adapter_Hamming_window_stm port map (
    in_1_Input_Signal_Valid_stm,
    in_2_Input_Signal_stm,
