...
entity floatComponent_DSPB_MMSE_dut_input_adapter_FFT_Adapter_arcTan2Block_typeSFloatIEA0Z0iuq0cp0ju20cp0jtj0u_atb is
end;

architecture normal of floatComponent_DSPB_MMSE_dut_input_adapter_FFT_Adapter_arcTan2Block_typeSFloatIEA0Z0iuq0cp0ju20cp0jtj0u_atb is
...
component floatComponent_DSPB_MMSE_dut_input_adapter_FFT_Adapter_arcTan2Block_typeSFloatIEA0Z0iuq0cp0ju20cp0jtj0u_stm is
    port (
...
dut : floatComponent_DSPB_MMSE_dut_input_adapter_FFT_Adapter_arcTan2Block_typeSFloatIEA0Z0iuq0cp0ju20cp0jtj0u port map (
    in_0_stm,
    in_1_stm,
    out_primWireOut_dut,
        clk,
...
sim : floatComponent_DSPB_MMSE_dut_input_adapter_FFT_Adapter_arcTan2Block_typeSFloatIEA0Z0iuq0cp0ju20cp0jtj0u_stm port map (
    in_0_stm,
    in_1_stm,
    out_primWireOut_stm,
        clk,
