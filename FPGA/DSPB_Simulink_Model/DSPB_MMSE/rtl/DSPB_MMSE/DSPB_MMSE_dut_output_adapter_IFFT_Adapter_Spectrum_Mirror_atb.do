...
if {! [file exists $base_dir/DSPB_MMSE_dut_output_adapter_IFFT_Adapter_Spectrum_Mirror]} {
    file delete -force $base_dir/DSPB_MMSE_dut_output_adapter_IFFT_Adapter_Spectrum_Mirror
}

project new $base_dir DSPB_MMSE_dut_output_adapter_IFFT_Adapter_Spectrum_Mirror
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/DSPB_MMSE/DSPB_MMSE_dut_output_adapter_IFFT_Adapter_Spectrum_Mirror_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/DSPB_MMSE/DSPB_MMSE_dut_output_adapter_IFFT_Adapter_Spectrum_Mirror_atb.vhd
vcom -quiet $base_dir/DSPB_MMSE/DSPB_MMSE_dut_output_adapter_IFFT_Adapter_Spectrum_Mirror_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_2_output_spectrum} mismatch] == 0 && $mismatch } {
                report_mismatch out_2_output_spectrum $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps DSPB_MMSE_dut_output_adapter_IFFT_Adapter_Spectrum_Mirror_atb 
    do $base_dir/DSPB_MMSE/DSPB_MMSE_dut_output_adapter_IFFT_Adapter_Spectrum_Mirror_atb.wav.do
