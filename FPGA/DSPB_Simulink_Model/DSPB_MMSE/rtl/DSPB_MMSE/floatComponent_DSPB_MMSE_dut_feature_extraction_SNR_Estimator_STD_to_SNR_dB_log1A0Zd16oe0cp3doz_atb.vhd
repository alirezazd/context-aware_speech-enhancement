...
entity floatComponent_DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_log1A0Z0dd6oq3cd16oe0cp3doz_atb is
end;

architecture normal of floatComponent_DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_log1A0Z0dd6oq3cd16oe0cp3doz_atb is
...
component floatComponent_DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_log1A0Z0dd6oq3cd16oe0cp3doz_stm is
    port (
...
dut : floatComponent_DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_log1A0Z0dd6oq3cd16oe0cp3doz port map (
    in_0_stm,
    out_primWireOut_dut,
        clk,
        areset
...
sim : floatComponent_DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_log1A0Z0dd6oq3cd16oe0cp3doz_stm port map (
    in_0_stm,
    out_primWireOut_stm,
        clk,
        areset
