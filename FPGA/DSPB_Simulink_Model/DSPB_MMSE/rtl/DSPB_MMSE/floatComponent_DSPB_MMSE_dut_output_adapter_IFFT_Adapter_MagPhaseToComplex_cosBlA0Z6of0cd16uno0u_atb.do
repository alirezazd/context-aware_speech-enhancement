...
if {! [file exists $base_dir/floatComponent_DSPB_MMSE_dut_output_adapter_IFFT_Adapter_MagPhaseToComplex_cosBlA0Z0of0cdj6of0cd16uno0u]} {
    file delete -force $base_dir/floatComponent_DSPB_MMSE_dut_output_adapter_IFFT_Adapter_MagPhaseToComplex_cosBlA0Z0of0cdj6of0cd16uno0u
}

project new $base_dir floatComponent_DSPB_MMSE_dut_output_adapter_IFFT_Adapter_MagPhaseToComplex_cosBlA0Z0of0cdj6of0cd16uno0u
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/DSPB_MMSE/floatComponent_DSPB_MMSE_dut_output_adapter_IFFT_Adapter_MagPhaseToComplex_cosBlA0Z6of0cd16uno0u_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/DSPB_MMSE/floatComponent_DSPB_MMSE_dut_output_adapter_IFFT_Adapter_MagPhaseToComplex_cosBlA0Zof0cd16uno0u_atb.vhd
vcom -quiet $base_dir/DSPB_MMSE/floatComponent_DSPB_MMSE_dut_output_adapter_IFFT_Adapter_MagPhaseToComplex_cosBlA0Zof0cd16uno0u_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps floatComponent_DSPB_MMSE_dut_output_adapter_IFFT_Adapter_MagPhaseToComplex_cosBlA0Z0of0cdj6of0cd16uno0u_atb 
    do $base_dir/DSPB_MMSE/floatComponent_DSPB_MMSE_dut_output_adapter_IFFT_Adapter_MagPhaseToComplex_cosBlA0Zcd16uno0u_atb.wav.do
