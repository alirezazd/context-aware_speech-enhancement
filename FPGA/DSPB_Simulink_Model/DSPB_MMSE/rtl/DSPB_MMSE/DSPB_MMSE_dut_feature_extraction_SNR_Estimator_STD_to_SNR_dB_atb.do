...
if {! [file exists $base_dir/DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB]} {
    file delete -force $base_dir/DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB
}

project new $base_dir DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/DSPB_MMSE/DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/DSPB_MMSE/DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_atb.vhd
vcom -quiet $base_dir/DSPB_MMSE/DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_1_estimated_SNR_valid} mismatch] == 0 && $mismatch } {
                report_mismatch out_1_estimated_SNR_valid $cyclenum
            }
            if { [catch {exa mismatch_out_2_estimated_SNR_dB} mismatch] == 0 && $mismatch } {
                report_mismatch out_2_estimated_SNR_dB $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_atb 
    do $base_dir/DSPB_MMSE/DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_atb.wav.do
