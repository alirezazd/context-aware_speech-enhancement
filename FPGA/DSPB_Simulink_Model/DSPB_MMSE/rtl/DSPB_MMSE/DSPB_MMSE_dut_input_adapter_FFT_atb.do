...
if {! [file exists $base_dir/DSPB_MMSE_dut_input_adapter_FFT]} {
    file delete -force $base_dir/DSPB_MMSE_dut_input_adapter_FFT
}

project new $base_dir DSPB_MMSE_dut_input_adapter_FFT
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/DSPB_MMSE/DSPB_MMSE_dut_input_adapter_FFT_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/DSPB_MMSE/DSPB_MMSE_dut_input_adapter_FFT_atb.vhd
vcom -quiet $base_dir/DSPB_MMSE/DSPB_MMSE_dut_input_adapter_FFT_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps DSPB_MMSE_dut_input_adapter_FFT_atb 
    do $base_dir/DSPB_MMSE/DSPB_MMSE_dut_input_adapter_FFT_atb.wav.do
