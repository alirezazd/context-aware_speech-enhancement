...
entity DSPB_MMSE_dut_feature_extraction_SNR_Estimator_1pass_STD_STD_noise_atb is
end;

architecture normal of DSPB_MMSE_dut_feature_extraction_SNR_Estimator_1pass_STD_STD_noise_atb is
...
component DSPB_MMSE_dut_feature_extraction_SNR_Estimator_1pass_STD_STD_noise_stm is
    port (
...
dut : DSPB_MMSE_dut_feature_extraction_SNR_Estimator_1pass_STD_STD_noise port map (
    in_1_valid_stm,
    in_2_input_data_stm,
    in_4_reset_stm,
    in_3_count_stm,
...
sim : DSPB_MMSE_dut_feature_extraction_SNR_Estimator_1pass_STD_STD_noise_stm port map (
    in_1_valid_stm,
    in_2_input_data_stm,
    in_4_reset_stm,
    in_3_count_stm,
