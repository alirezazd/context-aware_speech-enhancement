...
entity floatComponent_DSPB_MMSE_dut_output_adapter_IFFT_Adapter_MagPhaseToComplex_sinBlA0Z0of0cdj6of0cd16uno0u_atb is
end;

architecture normal of floatComponent_DSPB_MMSE_dut_output_adapter_IFFT_Adapter_MagPhaseToComplex_sinBlA0Z0of0cdj6of0cd16uno0u_atb is
...
component floatComponent_DSPB_MMSE_dut_output_adapter_IFFT_Adapter_MagPhaseToComplex_sinBlA0Z0of0cdj6of0cd16uno0u_stm is
    port (
...
dut : floatComponent_DSPB_MMSE_dut_output_adapter_IFFT_Adapter_MagPhaseToComplex_sinBlA0Z0of0cdj6of0cd16uno0u port map (
    in_0_stm,
    out_primWireOut_dut,
        clk,
        areset
...
sim : floatComponent_DSPB_MMSE_dut_output_adapter_IFFT_Adapter_MagPhaseToComplex_sinBlA0Z0of0cdj6of0cd16uno0u_stm port map (
    in_0_stm,
    out_primWireOut_stm,
        clk,
        areset
