...
entity DSPB_MMSE_dut_input_adapter_atb is
end;

architecture normal of DSPB_MMSE_dut_input_adapter_atb is
...
component DSPB_MMSE_dut_input_adapter_stm is
    port (
...
checkin_1_Input_Signal_Valid : process (clk, areset, in_1_Input_Signal_Valid_dut, in_1_Input_Signal_Valid_stm)
begin
END PROCESS;


-- General Purpose data in real output
checkin_2_Input_Signal : process (clk, areset, in_2_Input_Signal_dut, in_2_Input_Signal_stm)
begin
END PROCESS;


dut : DSPB_MMSE_dut_input_adapter port map (
...
sim : DSPB_MMSE_dut_input_adapter_stm port map (
    in_1_Input_Signal_Valid_stm,
    in_2_Input_Signal_stm,
