...
if {! [file exists $base_dir/standaloneTopLevel_DSPB_MMSE_dut_Output_IF]} {
    file delete -force $base_dir/standaloneTopLevel_DSPB_MMSE_dut_Output_IF
}

project new $base_dir standaloneTopLevel_DSPB_MMSE_dut_Output_IF
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/DSPB_MMSE/DSPB_MMSE_dut_Output_IF_fpc.do"
} else {
...
vcom -quiet $base_dir/DSPB_MMSE/standaloneTopLevel_DSPB_MMSE_dut_Output_IF.vhd
...
vcom -quiet -O0 $base_dir/DSPB_MMSE/DSPB_MMSE_dut_Output_IF_atb.vhd
vcom -quiet $base_dir/DSPB_MMSE/DSPB_MMSE_dut_Output_IF_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps standaloneTopLevel_DSPB_MMSE_dut_Output_IF_atb 
    do $base_dir/DSPB_MMSE/DSPB_MMSE_dut_Output_IF_atb.wav.do
