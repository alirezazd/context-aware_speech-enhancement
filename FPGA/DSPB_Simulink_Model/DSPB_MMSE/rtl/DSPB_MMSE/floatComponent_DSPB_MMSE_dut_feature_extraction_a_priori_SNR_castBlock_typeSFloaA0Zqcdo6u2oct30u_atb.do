...
if {! [file exists $base_dir/floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Zqcd06uqqcdo6u2oct30u]} {
    file delete -force $base_dir/floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Zqcd06uqqcdo6u2oct30u
}

project new $base_dir floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Zqcd06uqqcdo6u2oct30u
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/DSPB_MMSE/floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Zqcdo6u2oct30u_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/DSPB_MMSE/floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Zcdo6u2oct30u_atb.vhd
vcom -quiet $base_dir/DSPB_MMSE/floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Zcdo6u2oct30u_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Zqcd06uqqcdo6u2oct30u_atb 
    do $base_dir/DSPB_MMSE/floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Z6u2oct30u_atb.wav.do
