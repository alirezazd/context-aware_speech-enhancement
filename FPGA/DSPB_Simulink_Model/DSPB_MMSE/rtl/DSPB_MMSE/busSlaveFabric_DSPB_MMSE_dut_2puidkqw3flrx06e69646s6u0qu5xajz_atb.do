...
if {! [file exists $base_dir/busSlaveFabric_DSPB_MMSE_dut_2puidkqw3flrx06e69646s6u0qu5xajz]} {
    file delete -force $base_dir/busSlaveFabric_DSPB_MMSE_dut_2puidkqw3flrx06e69646s6u0qu5xajz
}

project new $base_dir busSlaveFabric_DSPB_MMSE_dut_2puidkqw3flrx06e69646s6u0qu5xajz
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/DSPB_MMSE/busSlaveFabric_DSPB_MMSE_dut_2puidkqw3flrx06e69646s6u0qu5xajz_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/DSPB_MMSE/busSlaveFabric_DSPB_MMSE_dut_2puidkqw3flrx06e69646s6u0qu5xajz_atb.vhd
vcom -quiet $base_dir/DSPB_MMSE/busSlaveFabric_DSPB_MMSE_dut_2puidkqw3flrx06e69646s6u0qu5xajz_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_sharedMemWireData_DSPB_MMSE_dut_input_IF_input_fifo_x} mismatch] == 0 && $mismatch } {
                report_mismatch out_sharedMemWireData_DSPB_MMSE_dut_input_IF_input_fifo_x $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps busSlaveFabric_DSPB_MMSE_dut_2puidkqw3flrx06e69646s6u0qu5xajz_atb 
    do $base_dir/DSPB_MMSE/busSlaveFabric_DSPB_MMSE_dut_2puidkqw3flrx06e69646s6u0qu5xajz_atb.wav.do
