...
entity floatComponent_DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_castA1Zd6oq3cd16oe0cp36hj0u_atb is
end;

architecture normal of floatComponent_DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_castA1Zd6oq3cd16oe0cp36hj0u_atb is
...
component floatComponent_DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_castA1Zd6oq3cd16oe0cp36hj0u_stm is
    port (
...
dut : floatComponent_DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_castA1Zd6oq3cd16oe0cp36hj0u port map (
    in_0_stm,
    out_primWireOut_dut,
        clk,
        areset
...
sim : floatComponent_DSPB_MMSE_dut_feature_extraction_SNR_Estimator_STD_to_SNR_dB_castA1Zd6oq3cd16oe0cp36hj0u_stm port map (
    in_0_stm,
    out_primWireOut_stm,
        clk,
        areset
