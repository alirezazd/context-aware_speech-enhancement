...
-- VHDL created from floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Zqcd06uqqcdo6u2oct30u
...
entity floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Zqcd06uqqcdo6u2oct30u_atb is
end;

architecture normal of floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Zqcd06uqqcdo6u2oct30u_atb is
...
component floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Zqcd06uqqcdo6u2oct30u_stm is
    port (
...
dut : floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Zqcd06uqqcdo6u2oct30u port map (
    in_0_stm,
    out_primWireOut_dut,
        clk,
        areset
...
sim : floatComponent_DSPB_MMSE_dut_feature_extraction_a_priori_SNR_castBlock_typeSFloaA0Zqcd06uqqcdo6u2oct30u_stm port map (
    in_0_stm,
    out_primWireOut_stm,
        clk,
        areset
