...
if {! [file exists $base_dir/dsp_vad_VAD]} {
    file delete -force $base_dir/dsp_vad_VAD
}

project new $base_dir dsp_vad_VAD
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/dsp_vad/dsp_vad_VAD_fpc.do"
} else {
...
vcom -quiet $base_dir/dsp_vad/dsp_vad_VAD.vhd
vcom -quiet $base_dir/dsp_vad/busSlaveFabric_dsp_vad_VAD_2uuidx4a06e636r6g6u0qu5xajz.vhd
vcom -quiet -O0 $base_dir/dsp_vad/dsp_vad_VAD_atb.vhd
vcom -quiet $base_dir/dsp_vad/dsp_vad_VAD_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps dsp_vad_VAD_atb 
    do $base_dir/dsp_vad/dsp_vad_VAD_atb.wav.do
