...
if {! [file exists $base_dir/busSlaveFabric_dsp_vad_VAD_2uuidx4a06e636r6g6u0qu5xajz]} {
    file delete -force $base_dir/busSlaveFabric_dsp_vad_VAD_2uuidx4a06e636r6g6u0qu5xajz
}

project new $base_dir busSlaveFabric_dsp_vad_VAD_2uuidx4a06e636r6g6u0qu5xajz
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/dsp_vad/busSlaveFabric_dsp_vad_VAD_2uuidx4a06e636r6g6u0qu5xajz_fpc.do"
} else {
...
vcom -quiet $base_dir/dsp_vad/dsp_vad_VAD_safe_path_msim.vhd
vcom -quiet $base_dir/dsp_vad/busSlaveFabric_dsp_vad_VAD_2uuidx4a06e636r6g6u0qu5xajz.vhd
vcom -quiet -O0 $base_dir/dsp_vad/busSlaveFabric_dsp_vad_VAD_2uuidx4a06e636r6g6u0qu5xajz_atb.vhd
vcom -quiet $base_dir/dsp_vad/busSlaveFabric_dsp_vad_VAD_2uuidx4a06e636r6g6u0qu5xajz_stm.vhd
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_AMMregisterWireData_dsp_vad_VAD_sys_mm_in_fft_out_pop_x} mismatch] == 0 && $mismatch } {
                report_mismatch out_AMMregisterWireData_dsp_vad_VAD_sys_mm_in_fft_out_pop_x $cyclenum
            }
            if { [catch {exa mismatch_out_AMMregisterWireData_dsp_vad_VAD_sys_mm_in_sample_data_x} mismatch] == 0 && $mismatch } {
                report_mismatch out_AMMregisterWireData_dsp_vad_VAD_sys_mm_in_sample_data_x $cyclenum
            }
            if { [catch {exa mismatch_out_AMMregisterWireData_dsp_vad_VAD_sys_mm_in_sample_in_valid_x} mismatch] == 0 && $mismatch } {
                report_mismatch out_AMMregisterWireData_dsp_vad_VAD_sys_mm_in_sample_in_valid_x $cyclenum
            }
        } else {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps busSlaveFabric_dsp_vad_VAD_2uuidx4a06e636r6g6u0qu5xajz_atb 
    do $base_dir/dsp_vad/busSlaveFabric_dsp_vad_VAD_2uuidx4a06e636r6g6u0qu5xajz_atb.wav.do
